...
- Integrasi Buku Acak API via Dio di [lib/data/repository/book_repository.dart](lib/data/repository/book_repository.dart) (list + detail, sort, pagination parameter `page`). Base URL sesuai dokumentasi Buku Acak API `https://bukuacak-9bdcb4ef2605.herokuapp.com/api/v1`.
...
- Widget item buku [lib/presentation/widgets/books/book_item.dart](lib/presentation/widgets/books/book_item.dart) dengan placeholder, loading indicator, dan handling error gambar.
